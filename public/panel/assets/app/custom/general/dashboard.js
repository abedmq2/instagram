...
var KTDashboard = function () {
    ...
    var dailySales = function (title, id, info) {
        var chartContainer = KTUtil.getByID(id);
    ...
    // Profit Share Chart.
    // Based on Chartjs plugin - http://www.chartjs.org/
    var profitShare = function (title, id, info) {
        ...
        var ctx = KTUtil.getByID(id).getContext('2d');
    ...
    // Activities Charts.
    // Based on Chartjs plugin - http://www.chartjs.org/
    var activitiesChart = function (month_order) {
    ...
    var daterangepickerInit = function () {
        ...
        function cb(start, end, label, first) {
            var title = '';
            var range = '';
            ...
            if (first) {
                ...
                var url = "admin/custom/filter?from=" + start.format('YYYY-MM-DD') + "&to=" + end.format('YYYY-MM-DD');
        ...
        picker.daterangepicker({
            ...
            ranges: {
                ...
                'أخير 30 يوم': [moment().subtract(29, 'days'), moment()],
